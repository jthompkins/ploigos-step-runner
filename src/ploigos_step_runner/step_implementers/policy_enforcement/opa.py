...
class OpenPolicyAgent(StepImplementer):  # pylint: disable=too-few-public-methods
    ...
    def upload_to_rekor(self, rekor_server, extra_data_file, gpg_key, gpg_user, work_dir_path):
    ...
    def _run_step(self):
        ...
        rekor_entry, rekor_uuid = self.upload_to_rekor(rekor_server, extra_data_file, self.get_value('gpg-key'), self.get_value('gpg-user'), self.work_dir_path)
